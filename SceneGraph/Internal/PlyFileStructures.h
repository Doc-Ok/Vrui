...
#ifndef SCENEGRAPH_INTERNAL_PLYFILESTRUCTURES_INCLUDED
#define SCENEGRAPH_INTERNAL_PLYFILESTRUCTURES_INCLUDED
...
class PLYProperty
	...
	const std::string& getName(void) const // Returns property's name
		{
		return name;
		}
	};
