...
#ifndef GLEXTENSIONS_GLARBCONSERVATIVEDEPTH_INCLUDED
#define GLEXTENSIONS_GLARBCONSERVATIVEDEPTH_INCLUDED
...
class GLARBConservativeDepth:public GLExtension
	{
	/* Elements: */
	private:
	static GL_THREAD_LOCAL(GLARBConservativeDepth*) current; // Pointer to extension object for current OpenGL context
	static const char* name; // Extension name
	
	/* Constructors and destructors: */
	private:
	GLARBConservativeDepth(void);
	public:
	virtual ~GLARBConservativeDepth(void);
